  ...
  <div class="center-container-top">
    ...
    <div class="button-utils right-button-utils">
      <template v-if="props.type == 0 && flowState == 0">
        ...
        <a-popover trigger="click" placement="bottom" overlayClassName="jnpf-flow-common-popover" arrow-point-at-center destroyTooltipOnHide>
          <template #content>
            <div class="jnpf-command-history-popover">
      ...
      <template v-if="flowState == 0">
        <a-divider type="vertical" />
        <a-popover v-if="type == 0" trigger="click" placement="bottom" overlayClassName="jnpf-flow-common-popover" arrow-point-at-center destroyTooltipOnHide>
          <template #content>
...
<script lang="ts" setup>
  ...
  import { DEFAULT_DISTANCE } from '../../bpmn/config/constants';
