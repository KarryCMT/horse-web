...
| ------------------------ | ------------- | ---------------------- |
| **后端**(任一后端服务)   |                 |                        |
| jnpf-java-boot           | v5.0.x-stable | Java 单体项目源码      |
| jnpf-java-cloud          | v5.0.x-stable | Java 微服务项目源码    |
| jnpf-dotnet              | v5.0.x-stable | .NET 单体项目源码      |
| jnpf-dotnet-cloud        | v5.0.x-stable | .NET 微服务项目源码    |
| **前端**                 |                   |                        |
| jnpf-web-datascreen-vue3 | v5.0.x-stable | 大屏前端项目源码(Vue3) |
| jnpf-web-datareport      |  v5.0.x-stable | 报表前端项目源码       |
