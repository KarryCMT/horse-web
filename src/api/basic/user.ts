...
export function loginApi(params: LoginParams) {
    ...
    return Promise.resolve({
        ...
        "msg": "Success",
        "data": {
            "token": "bearer eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..vmLnTDu_gFO073lsDWGDCw52X5Dde0v48eV_mvIpZlk",
            "theme": "classic",
            "wl_qrcode": null
        }
    })
...
export function doLogout() {
    ...
    return Promise.resolve({"code":200,"msg":"注销成功"})
}
// 锁屏解锁登录
