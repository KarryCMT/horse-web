    ...
    <a-form :colon="false" :model="formConf" class="config-content" layout="vertical">
      <template v-if="activeKey === 1">
        ...
        <a-form-item label="审批设置">
          ...
          <a-form-item label="表单字段" class="!mb-0" v-if="formConf.assigneeType === 4">
            <a-input-group compact>
              <jnpf-select v-model:value="formConf.formFieldType" :options="formFieldTypeOptions" class="!w-100px" />
              <jnpf-select
          ...
          <a-form-item class="!mb-0 !mt-10px" v-if="formConf.assigneeType === 6">
            ...
            <jnpf-select v-model:value="formConf.extraRule" :options="extraRuleOptions" />
          </a-form-item>
        </a-form-item>
        ...
        <a-form-item label="抄送设置">
          ...
          <a-form-item class="!mb-0" v-if="formConf.isFormFieldCopy">
            <a-input-group compact>
              <jnpf-select v-model:value="formConf.copyFormFieldType" :options="formFieldTypeOptions" class="!w-100px" />
              <jnpf-select
      ...
      <template v-if="activeKey === 2">
        ...
        <a-form-item v-if="props.type != 1" label="分流规则">
          <jnpf-select v-model:value="formConf.divideRule" :options="divideRuleOptions" />
        </a-form-item>
      </template>
          ...
          <template v-if="formConf.timeLimitConfig.on === 1">
            <a-form-item class="!mt-12px" label="节点处理截止时间">
              ...
              <div class="mt-10px" v-if="formConf.timeLimitConfig.nodeLimit === 2">
                <jnpf-select class="!w-332px" v-model:value="formConf.timeLimitConfig.formField" :options="usedFormItems" showSearch allowClear />
              </div>
